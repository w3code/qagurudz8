...
public class ShopSearchTest extends TestBase {
    ...
    static Stream<Arguments> goodSearchTest_MethodSource() {
        return Stream.of(
                ...
                Arguments.of("Bosch GSR18V", List.of("BOSCH GSR18V-190-RT 18V Li-Ion Cordless 18-Volt"))
        );
    }
    ...
    @CsvSource(value = {
            ...
            "Bosch GSR18V|BOSCH GSR18V-190-RT 18V Li-Ion Cordless 18-Volt"},
            delimiter = '|')
    @Tag("Blocker")
    @DisplayName("Power Tools search")
    @ParameterizedTest(name = "Search {0} item contains \"{1}\" title")
    ...
    @Disabled
    @ValueSource(strings = {"dewalt dcd791b", "Milwaukee 2407-20", "Makita DHP482Z", "Bosch GSR18V"})
    @Tag("Blocker")
    @DisplayName("Power Tools search")
